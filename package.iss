...
OutputBaseFilename=bibledit-1.0.558
Compression=lzma
...
Filename: "{app}\vc_redist.x86.exe"; Parameters: "/install /passive /norestart"; Description: "Install Visual C++ Redistributable 2015"; Flags: skipifsilent
