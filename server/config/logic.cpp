...
void config_logic_load_settings ()
{
  ...
  config_globals_log_network = file_or_dir_exists/*_cpp17*/ (path);
}
...
string config_logic_http_network_port ()
{
  ...
  string path = filter_url_create_root_path_cpp17 ({config_logic_config_folder (), "network-port"});
...
{
  // Read the port number from file.
  string path = filter_url_create_root_path_cpp17 ({config_logic_config_folder (), "network-port-secure"});
...
{
  string path = filter_url_create_root_path_cpp17 ({config_logic_config_folder (), "admin-username"});
...
{
  string path = filter_url_create_root_path_cpp17 ({config_logic_config_folder (), "admin-password"});
  return filter_string_trim (filter_url_file_get_contents (path));
}
...
{
  string path = filter_url_create_root_path_cpp17 ({config_logic_config_folder (), "admin-email"});
  return filter_string_trim (filter_url_file_get_contents (path));
}
...
string config_logic_manual_user_facing_url ()
{
  ...
  string path = filter_url_create_root_path_cpp17 ({config_logic_config_folder (), "userfacingurl.conf"});
...
{
  return file_or_dir_exists/*_cpp17*/ (filter_url_create_root_path_cpp17 ({config_logic_config_folder (), "browser.https"}));
}
...
{
  return file_or_dir_exists/*_cpp17*/ (filter_url_create_root_path_cpp17 ({config_logic_config_folder (), "client.https"}));
}
...
bool config_logic_indonesian_cloud_free ()
{
  ...
  status = file_or_dir_exists/*_cpp17*/ (path);
  read = true;
